...
export default function PrivacyPolicy() {
  return (
    <div className="flex min-h-screen flex-col text-gray-200">
      <NavBar />
      <VStack className="w-full max-w-6xl mx-auto py-12" space={16}>
        <p className="text-4xl">Terms of Service</p>
        <VStack space={6}>
          <p className="text-4xl">1. Introduction‍</p>
          <p>
            {`Welcome to S2 Labs Inc. (“Company”, “we”, “our”, “us”)! As you have
            ...
            https://metlo.com operated by S2 Labs Inc. Our Privacy Policy also
            ...
            web pages. Please read it here https://www.metlo.com/privacy-policy.
            ...
            Service, but please let us know by emailing at info@metlo.com so we
        ...
        <VStack space={6}>
          <p className="text-4xl">2. Communications</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">3. Purchases</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">4. Subscriptions</p>
          <p>
            {`Some parts of Service are billed on a subscription basis
            (“Subscription(s)”). You will be billed in advance on a recurring
            and periodic basis (“Billing Cycle”). Billing cycles are set on an
            annual basis. At the end of each Billing Cycle, your Subscription
            will automatically renew under the exact same conditions unless you
            cancel it or S2 Labs Inc. cancels it. You may cancel your
            Subscription renewal either through your online account management
            page or by contacting S2 Labs Inc. customer support team. A valid
            payment method, including credit card or PayPal, is required to
            process the payment for your subscription. You shall provide S2 Labs
            ...
            you automatically authorize S2 Labs Inc. to charge all Subscription
            fees incurred through your account to any such payment instruments.
            Should automatic billing fail to occur for any reason, S2 Labs Inc.
        ...
        <VStack space={6}>
          <p className="text-4xl">5. Free Trial</p>
          <p>
            {`S2 Labs Inc. may, at its sole discretion, offer a Subscription with
            ...
            for Free Trial, you will not be charged by S2 Labs Inc. until Free
            ...
            selected. At any time and without notice, S2 Labs Inc. reserves the
            right to (i) modify Terms of Service of Free Trial offer, or (ii)
            cancel such Free Trial offer.`}
          </p>
        </VStack>
        <VStack space={6}>
          <p className="text-4xl">6. Fee Changes</p>
          <p>
            {`S2 Labs Inc., in its sole discretion and at any time, may modify
            ...
            S2 Labs Inc. will provide you with a reasonable prior notice of any
        ...
        <VStack space={6}>
          <p className="text-4xl">7. Refunds</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">8. Content</p>
          <p>
            {`Content found on or through this Service are the property of S2 Labs
        ...
        <VStack space={6}>
          <p className="text-4xl">9. Prohibited Uses</p>
          <p>
            {`You may use Service only for lawful purposes and in accordance with
            Terms. You agree not to use Service: (a) In any way that violates
            any applicable national or international law or regulation. (b) For
            ...
            Additionally, you agree not to: (a) Use Service in any manner that
            ...
            engage in real time activities through Service. (b) Use any robot,
            ...
            material on Service. (c) Use any manual process to monitor or copy
            any of the material on Service or for any other unauthorized purpose
            without our prior written consent. (d) Use any device, software, or
            routine that interferes with the proper working of Service. (e)
            Introduce any viruses, trojan horses, worms, logic bombs, or other
            material which is malicious or technologically harmful. (f) Attempt
            ...
            server, computer, or database connected to Service. (g) Attack
            Service via a denial-of-service attack or a distributed
            denial-of-service attack. (h) Take any action that may damage or
            falsify Company rating. (i) Otherwise attempt to interfere with the
            proper working of Service.`}
          </p>
        </VStack>
        <VStack space={6}>
          <p className="text-4xl">10. Analytics</p>
          <p>
            ...
            the ads of its own advertising network. For more information on the
            privacy practices of Google, please visit the Google Privacy Terms
            web page: https://policies.google.com/privacy?hl=en We also
            encourage you to review the Google's policy for safeguarding your
            data: https://support.google.com/analytics/answer/6004245.`}
          </p>
        </VStack>
        <VStack space={6}>
          <p className="text-4xl">11. No Use By Minors</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">12. Accounts</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">13. Intellectual Property</p>
          <p>
            {`Service and its original content (excluding Content provided by
            users), features and functionality are and will remain the exclusive
            property of S2 Labs Inc. and its licensors. Service is protected by
            ...
            consent of S2 Labs Inc.`}
          </p>
        </VStack>
        <VStack space={6}>
          <p className="text-4xl">14. Copyright Policy</p>
          <p>
            ...
            infringement, please submit your claim via email to ~, with the
            ...
            copyright. 15. DMCA Notice and Procedure for Copyright Infringement
            ...
            for further detail): (a) an electronic or physical signature of the
            ...
            has been infringed, including the URL (i.e., web page address) of
            the location where the copyrighted work exists or a copy of the
            copyrighted work; (c) identification of the URL or other specific
            location on Service where the material that you claim is infringing
            is located; (d) your address, telephone number, and email address;
            (e) a statement by you that you have a good faith belief that the
            disputed use is not authorized by the copyright owner, its agent, or
            the law; (f) a statement by you, made under penalty of perjury, that
            ...
            info@metlo.com 16. Error Reporting and Feedback You may provide us
            either directly at info@metlo.com or via third party sites and tools
            ...
            purpose The third party sites and tools mentioned above include the
            following: Sentry Sentry is open-source error tracking solution
            provided by Functional Software Inc. More information is available
            here: https://sentry.io/privacy/`}
          </p>
        </VStack>
        <VStack space={6}>
          <p className="text-4xl">17. Links To Other Web Sites</p>
          <p>
            {`Our Service may contain links to third party web sites or services
            that are not owned or controlled by S2 Labs Inc. S2 Labs Inc. has no
            ...
            their websites. YOU ACKNOWLEDGE AND AGREE THAT S2 LABS INC. SHALL
            ...
            OR THROUGH ANY SUCH THIRD PARTY WEB SITES OR SERVICES. WE STRONGLY
            ADVISE YOU TO READ THE TERMS OF SERVICE AND PRIVACY POLICIES OF ANY
            THIRD PARTY WEB SITES OR SERVICES THAT YOU VISIT.`}
          </p>
        </VStack>
        <VStack space={6}>
          <p className="text-4xl">18. Disclaimer Of Warranty</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">19. Limitation Of Liability</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">20. Termination</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">21. Governing Law</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">22. Changes To Service</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">23. Amendments To Terms</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">24. Waiver And Severability</p>
          <p>
        ...
        <VStack space={6}>
          <p className="text-4xl">25. Acknowledgement</p>
          {`BY USING SERVICE OR OTHER SERVICES PROVIDED BY US, YOU ACKNOWLEDGE
          THAT YOU HAVE READ THESE TERMS OF SERVICE AND AGREE TO BE BOUND BY
          THEM.`}
          <VStack space={6}>
            <p className="text-4xl">26. Contact Us</p>
            <p>
              Please send your feedback, comments, requests for technical
              support: By email: info@metlo.com.
            </p>
          </VStack>
        </VStack>
      </VStack>
