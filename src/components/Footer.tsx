...
const navigation = {
  ...
  company: [
    { name: "Blog", href: "https://blog.metlo.com" },
    { name: "Jobs", href: "mailto:akshay@metlo.com" },
  ],
  legal: [
  ...
  social: [
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/metlo",
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/MetloHQ",
      icon: (props: Record<string, any>) => (
    ...
    <footer className="bg-dark" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <Image src="/logo.svg" alt="Metlo" width={24} height={24} priority />
        ...
        <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; 2023 S2 Labs, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
